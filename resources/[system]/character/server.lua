...
AddEventHandler("character:finishedCharacter",function(characterNome,characterSobrenome,characterAge,currentCharacterMode)
	local source = source
...
function doSpawnPlayer(source,user_id,firstspawn)
	...
	TriggerEvent("rony:character-barbershop:init",user_id)
