...
const updateChest = () => {
	$.post("http://vrp_chest/requestChest",JSON.stringify({}),(data) => {
		...
		$('#inventory').html(`
			<div class="peso"><b>ESPAÇO OCUPADO:</b>  ${(data.peso).toFixed(2)}    <s>|</s>    <b>ESPAÇO LIVRE:</b>  ${(data.maxpeso-data.peso).toFixed(2)}    <s>|</s>    <b>ESPAÇO TOTAL:</b>  ${(data.maxpeso).toFixed(2)}</div>
			<div class="peso2"><b>ESPAÇO OCUPADO:</b>  ${(data.peso2).toFixed(2)}    <s>|</s>    <b>ESPAÇO LIVRE:</b>  ${(data.maxpeso2-data.peso2).toFixed(2)}    <s>|</s>    <b>ESPAÇO TOTAL:</b>  ${(data.maxpeso2).toFixed(2)}</div>
			<div class="esquerda">
				${nameList2.map((item) => (`
