	...
	while true do
		...
		if not processo then
			...
			if distancia <= 180 then
				...
				if distancia <= 180 then
					drawTxt("PRESSIONE  ~g~E~w~  PARA INICIAR A PESCARIA",4,0.5,0.93,0.50,255,255,255,180)
		...
		if processo then
			rsTD = 4
			drawTxt("AGUARDE ~g~"..segundos.."~w~ SEGUNDOS ATÉ FISGAR UM PEIXE",4,0.5,0.93,0.50,255,255,255,180)
		end
		Wait(rsTD)
	end
end)
