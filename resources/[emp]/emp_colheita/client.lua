		...
		if not servico then
			...
			if distance <= 80 then
				...
				if distance <= 1.2 then
					drawTxt("PRESSIONE  ~g~E~w~  PARA INICIAR A COLHEITA",4,0.5,0.93,0.50,255,255,255,180)
			...
			for _,v in pairs(locais) do
				...
				if distance2 <= 20 then
					...
					if distance2 <= 2 and not andamento then
						drawTxt("PRESSIONE  ~g~E~w~  PARA INICIAR A SEPARAÇÃO DOS GRÃOS",4,0.5,0.93,0.50,255,255,255,180)
